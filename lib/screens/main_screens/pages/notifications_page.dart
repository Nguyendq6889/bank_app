import 'package:bank_app/app_assets/app_colors.dart';
                                ...
                                (index % 2 == 0) ? Text.rich(
                                  TextSpan(
                                    ...
                                    children: [
                                      ...
                                      TextSpan(text: '1014686229', style: AppStyles.textButtonBlack.copyWith(fontSize: 12)),
                                      TextSpan(text: ' ${'received_amount'.tr()} '),
                                      TextSpan(text: '+100,000 ${'currency'.tr()}', style: AppStyles.textButtonBlack.copyWith(fontSize: 12, color: const Color(0xff49A66A))),
                                    ]
                                  )
                                ) : Text.rich(
                                  TextSpan(
                                    ...
                                    children: [
                                      ...
                                      TextSpan(text: '-100,000 ${'currency'.tr()}', style: AppStyles.textButtonBlack.copyWith(fontSize: 12, color: const Color(0xffD03339))),
                                    ]
                                  )
                                ),
                                const SizedBox(height: 4),
